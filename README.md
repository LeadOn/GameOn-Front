...
This project is a front-end for the GameOn! Front-End, done using Angular 22 / TailwindCSS v4, and will be running live on [this site](https://gameon.valentinvirot.fr/).
