...
@Component({
  selector: 'app-lol-old-game-details-player-graph',
  standalone: false,

  templateUrl: './lol-old-game-details-player-graph.component.html',
  styleUrl: './lol-old-game-details-player-graph.component.scss',
})
export class LolOldGameDetailsPlayerGraphComponent
