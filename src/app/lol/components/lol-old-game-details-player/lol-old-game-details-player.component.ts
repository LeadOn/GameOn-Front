...
@Component({
  selector: 'app-lol-old-game-details-player',
  standalone: false,

  templateUrl: './lol-old-game-details-player.component.html',
  styleUrl: './lol-old-game-details-player.component.scss',
})
export class LolOldGameDetailsPlayerComponent implements OnChanges {
  @Input()
