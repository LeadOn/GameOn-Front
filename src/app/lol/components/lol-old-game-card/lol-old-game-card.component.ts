...
@Component({
  selector: 'app-lol-old-game-card',
  standalone: false,

  templateUrl: './lol-old-game-card.component.html',
  styleUrl: './lol-old-game-card.component.scss',
})
export class LolOldGameCardComponent implements OnChanges {
  @Input()
